...
async def cb_handler(client: Client, query: CallbackQuery):
    if query.data == "close_data":
        ...
        reply_markup = InlineKeyboardMarkup(btn)
        m=await query.message.reply_sticker("CAACAgUAAxkBAAIsS2etinkhOsp9Akmqm-gsClWwIIRpAALCCQACWxwoV6Q9b8ZhXuNXHgQ") 
        await m.delete()
    ...
    # If the user isn't an admin, return
      ...
      await client.edit_message_media(
       ...
       await client.edit_message_media(
        ...
        buttons = [[
            InlineKeyboardButton('Repo', url='https://envs.sh/Ewy.mp4')
        ],[
       ...
       buttons = [[
	      InlineKeyboardButton('⇆ ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘs ⇆', url=f'http://t.me/{temp.U_NAME}?startgroup=start')
              ...
              InlineKeyboardButton('sᴜᴘᴘᴏʀᴛ', url=f'https://t.me/+LfMoLOc65BkyOThl'),
       ]]
       reply_markup = InlineKeyboardMarkup(buttons)
       await client.edit_message_media(
          chat_id=query.message.chat.id,
